  ...
  <div className="grid grid-cols-2 px-8 py-6">
    <div class="h-full flex flex-col items-center justify-center">
      <p class="mt-4 text-center text-3xl font-bold font-poppins animate-typing">
        Crie uma conta e  <br/> participe da nossa <br/> <span style={{ color: "red" }}>comunidade</span>
      </p>
    ...
    <form onSubmit={handleRegister}  className="h-full flex flex-col  bg-cinza border-2 border-black rounded-lg px-4 py-2 mt-4">
      ...
      <Link type="submit" className="inline-block px-4 py-2 mt-20 text-sm font-medium leading-5 text-white bg-red-600 border border-transparent rounded-lg hover:bg-red-700 focus:outline-none focus:shadow-outline-red active:bg-red-800 text-center">
          Vamos lá!
      </Link>
    </form>
  </div>
